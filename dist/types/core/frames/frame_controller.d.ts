...
import { RenderDelegate } from "./frame_renderer";
import { Locatable } from "../location";
export declare class FrameController implements FetchRequestDelegate, FormInterceptorDelegate, FormSubmissionDelegate, LinkInterceptorDelegate, RenderDelegate {
    ...
    viewRendered(newBody: HTMLBodyElement): Promise<void>;

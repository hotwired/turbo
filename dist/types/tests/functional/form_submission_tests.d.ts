...
export declare class FormSubmissionTests extends TurboDriveTestCase {
    ...
    "test frame form GET submission from submitter with data-turbo-frame"(): Promise<void>;
    "test frame form POST submission from submitter with data-turbo-frame"(): Promise<void>;

    ...
    constructor(delegate) {
        ...
        this.submitBubbled = ((event) => {
            if (!event.defaultPrevented) {
                ...
                const submitter = event.submitter || undefined;
                if (form) {
                    const methodIsHttp = !!fetchMethodFromString((submitter === null || submitter === void 0 ? void 0 : submitter.getAttribute("formmethod")) || form.method);
                    if (methodIsHttp && this.delegate.willSubmitForm(form, submitter)) {
                        event.preventDefault();

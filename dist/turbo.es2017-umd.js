...
(function (global, factory) {
    ...
    class StreamObserver {
        constructor(delegate) {
            ...
            this.started = false;
            this.prepareFormSubmission = ((event) => {
                var _a;
                const formSubmission = (_a = event.detail) === null || _a === void 0 ? void 0 : _a.formSubmission;
                const headers = formSubmission.fetchRequest.fetchOptions.headers;
                if (headers) {

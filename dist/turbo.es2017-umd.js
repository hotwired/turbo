...
(function (global, factory) {
    ...
    class FrameRenderer extends Renderer {
        constructor(delegate, frameElement, newSnapshot) {
            super();
            this.delegate = delegate;
        ...
        static render(delegate, callback, frameElement, newSnapshot) {
            return new this(delegate, frameElement, newSnapshot).renderView(callback);
        }
        async renderView(callback) {
        ...
        async findFrameElement(container) {
            let element;
    ...
    class SnapshotRenderer extends Renderer {
        ...
        relocateCurrentBodyPermanentElements() {
            return this.getCurrentBodyPermanentElements().reduce((placeholders, permanentElement) => {
                const newElement = this.newSnapshot.getPermanentElementById(permanentElement.id);
                if (newElement) {
                    const placeholder = createPlaceholderForPermanentElement$1(permanentElement);

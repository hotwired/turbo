...
(function (global, factory) {
    ...
    function dispatch(eventName, { target, cancelable, bubbles, detail } = {}) {
    ...
    class FormSubmission {
        ...
        requestFinished(request) {
            ...
            dispatch("turbo:submit-end", { target: this.formElement, detail: Object.assign({ formSubmission: this }, this.result), bubbles: true });

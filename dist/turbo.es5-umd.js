...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FrameController = (function () {
                ...
                entries.forEach(function (_a) {
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (!isIntersecting) return [3, 2];
                                    src = this.element.src;
                                    if (!src) return [3, 2];
                                    return [4, this.visit(src)];
                                case 1:
                                    _b.sent();
        ...
        FrameController.prototype.observeIntersections = function () {
            this.intersectionObserver.observe(this.element);
        };
        FrameController.prototype.unobserveIntersections = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, new Promise(function (resolve) {
                            ...
                            Object.defineProperty(_this.element, "loaded", { configurable: true });
                        })];
                });
            });
        };
    ...
    (function (FrameLoadingStyle) {
        FrameLoadingStyle[FrameLoadingStyle["eager"] = 0] = "eager";
        FrameLoadingStyle[FrameLoadingStyle["lazy"] = 1] = "lazy";
    ...
    var FrameElement = (function (_super) {
        ...
        FrameElement.prototype.attributeChangedCallback = function () {
            if (this.src && this.isActive && this.loading == FrameLoadingStyle.eager) {
                this.controller.visit(this.src);
            }
        };
        ...
        Object.defineProperty(FrameElement.prototype, "loading", {
            ...
            set: function (value) {
                if (value) {
                    this.setAttribute("loading", value.toString());
                }
                else {

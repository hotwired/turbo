    ...
    ***************************************************************************** */
    ...
    var StreamObserver = (function () {
        function StreamObserver(delegate) {
            ...
            this.started = false;
            this.prepareFormSubmission = (function (event) {
                var _a;
                var formSubmission = (_a = event.detail) === null || _a === void 0 ? void 0 : _a.formSubmission;
                var headers = formSubmission.fetchRequest.fetchOptions.headers;
                if (headers) {

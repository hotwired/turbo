...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FrameRenderer = (function (_super) {
        ...
        function FrameRenderer(delegate, frameElement, newSnapshot) {
            var _this = _super.call(this) || this;
            _this.delegate = delegate;
            _this.frameElement = frameElement;
            _this.currentSnapshot = Snapshot.wrap(frameElement.innerHTML);
            _this.newSnapshot = newSnapshot;
            _this.newBody = newSnapshot.bodyElement;
            return _this;
        }
        FrameRenderer.render = function (delegate, callback, frameElement, newSnapshot) {
            return new this(delegate, frameElement, newSnapshot).renderView(callback);
        };
        FrameRenderer.prototype.renderView = function (callback) {
            return __awaiter(this, void 0, void 0, function () {
                var newFrameElement;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.findFrameElement(this.newBody)];
                        case 1:
                            newFrameElement = _a.sent();
                            if (newFrameElement) {
                                _super.prototype.renderView.call(this, function () {
                                    var placeholders = _this.relocateCurrentBodyPermanentElements();
                                    replaceElementWithElement(_this.frameElement, newFrameElement);
                                    _this.replacePlaceholderElementsWithClonedPermanentElements(placeholders);
        ...
        FrameRenderer.prototype.findFrameElement = function (container) {
            return __awaiter(this, void 0, void 0, function () {
                var element;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(element = container.querySelector("turbo-frame[src][recurse~=" + this.id + "]"))) return [3, 4];
                            if (!(element instanceof FrameElement)) return [3, 2];
                            return [4, element.loaded];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4, this.findFrameElement(element)];
                        case 3: return [2, _a.sent()];
                        case 4: return [2];
                    }
                });
        ...
        FrameRenderer.prototype.relocateCurrentBodyPermanentElements = function () {
            var _this = this;
            return this.currentBodyPermanentElements.reduce(function (placeholders, permanentElement) {
        ...
        FrameRenderer.prototype.replacePlaceholderElementsWithClonedPermanentElements = function (placeholders) {
            var e_1, _a;
            try {
        ...
        Object.defineProperty(FrameRenderer.prototype, "currentBodyPermanentElements", {
            get: function () {
        ...
        FrameRenderer.prototype.focusFirstAutofocusableElement = function () {
            var element = this.newSnapshot.findFirstAutofocusableElement();
            if (elementIsFocusable(element)) {
                element.focus();
            }
        };
        Object.defineProperty(FrameRenderer.prototype, "id", {
            get: function () {
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.viewWillRender = function (newBody) {
        };
        FrameController.prototype.viewRendered = function (newBody) {
            return __awaiter(this, void 0, void 0, function () {
                var element;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            element = getFrameElementById(this.id);
                            if (!element) return [3, 2];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            html = _a.sent();
                            if (html) {
                                FrameRenderer.render(this, function () { }, this.element, Snapshot.wrap(html));
                            }
                            return [2];
                    }
                });
    ...
    var SnapshotRenderer = (function (_super) {
        ...
        SnapshotRenderer.prototype.relocateCurrentBodyPermanentElements = function () {
            ...
            return this.getCurrentBodyPermanentElements().reduce(function (placeholders, permanentElement) {
                var newElement = _this.newSnapshot.getPermanentElementById(permanentElement.id);
                if (newElement) {
                    var placeholder = createPlaceholderForPermanentElement$1(permanentElement);
                    replaceElementWithElement$1(permanentElement, placeholder.element);
                    replaceElementWithElement$1(newElement, permanentElement);
                    return __spread(placeholders, [placeholder]);
                }
                else {
                    return placeholders;
        ...
        SnapshotRenderer.prototype.replacePlaceholderElementsWithClonedPermanentElements = function (placeholders) {
            ...
            try {
                for (var placeholders_1 = __values(placeholders), placeholders_1_1 = placeholders_1.next(); !placeholders_1_1.done; placeholders_1_1 = placeholders_1.next()) {
                    var _b = placeholders_1_1.value, element = _b.element, permanentElement = _b.permanentElement;
                    var clonedElement = permanentElement.cloneNode(true);
                    replaceElementWithElement$1(element, clonedElement);
                }
            }
        ...
        SnapshotRenderer.prototype.activateNewBodyScriptElements = function () {
            ...
            try {
                for (var _b = __values(this.getNewBodyScriptElements()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    replaceElementWithElement$1(inertScriptElement, activatedScriptElement);
                }
            }
        ...
        SnapshotRenderer.prototype.assignNewBody = function () {
            if (document.body) {
                replaceElementWithElement$1(document.body, this.newBody);
            }
            else {
        ...
        SnapshotRenderer.prototype.focusFirstAutofocusableElement = function () {
            var element = this.newSnapshot.findFirstAutofocusableElement();
            if (elementIsFocusable$1(element)) {
                element.focus();
            }
        };
    ...
    function createPlaceholderForPermanentElement$1(permanentElement) {
        var element = document.createElement("meta");
        element.setAttribute("name", "turbo-permanent-placeholder");
        element.setAttribute("content", permanentElement.id);
        return { element: element, permanentElement: permanentElement };
    }
    function replaceElementWithElement$1(fromElement, toElement) {
        var parentElement = fromElement.parentElement;
        if (parentElement) {
            return parentElement.replaceChild(toElement, fromElement);
        }
    }
    function elementIsFocusable$1(element) {
        return element && typeof element.focus == "function";
    }

        ...
        function FormSubmitObserver(delegate) {
            ...
            this.submitBubbled = (function (event) {
                if (!event.defaultPrevented) {
                    ...
                    var submitter = event.submitter || undefined;
                    if (form) {
                        var methodIsHttp = !!fetchMethodFromString((submitter === null || submitter === void 0 ? void 0 : submitter.getAttribute("formmethod")) || form.method);
                        if (methodIsHttp && _this.delegate.willSubmitForm(form, submitter)) {
                            event.preventDefault();

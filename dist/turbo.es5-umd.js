...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function dispatch(eventName, _a) {
        var _b = _a === void 0 ? {} : _a, target = _b.target, cancelable = _b.cancelable, bubbles = _b.bubbles, detail = _b.detail;
        var event = new CustomEvent(eventName, { cancelable: cancelable, bubbles: bubbles, detail: detail });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            dispatch("turbo:before-fetch-request", { bubbles: true, detail: { fetchOptions: fetchOptions } });
                            _a.label = 1;
                        case 1:
        ...
        FetchRequest.prototype.receive = function (response) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    event = dispatch("turbo:before-fetch-response", { cancelable: true, bubbles: true, detail: { fetchResponse: fetchResponse } });
    ...
    var FormSubmission = (function () {
        ...
        FormSubmission.prototype.requestFinished = function (request) {
            ...
            dispatch("turbo:submit-end", { target: this.formElement, detail: __assign({ formSubmission: this }, this.result), bubbles: true });
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.linkClickIntercepted = function (element, url) {
            ...
            var location = Location.wrap(url);
            var event = dispatch("turbo:before-visit", { target: frame, bubbles: false, detail: { url: location.absoluteURL } });
            if (!event.defaultPrevented) {
                frame.src = url;
            }
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, new Promise(function (resolve) {
                            ...
                            dispatch("turbo:visit", { target: _this.element, bubbles: false, detail: { url: location.absoluteURL } });
                            request.perform();
                        }).then(function () {
                            _this.recordTimingMetric(TimingMetric.visitEnd);
                            dispatch("turbo:load", { target: _this.element, bubbles: false, detail: { url: location.absoluteURL, timing: _this.timingMetrics } });
                        })];
                });
            });
        };
        ...
        FrameController.prototype.clearTimingMetrics = function () {
            this.timingMetrics = {};
        };
        FrameController.prototype.recordTimingMetric = function (metric) {
            this.timingMetrics[metric] = new Date().getTime();
        };
    ...
    var FrameRedirector = (function () {
        ...
        FrameRedirector.prototype.linkClickIntercepted = function (element, url) {
            ...
            var location = Location.wrap(url);
            if (frame) {
                var event_1 = dispatch("turbo:before-visit", { target: frame, bubbles: false, detail: { url: location.absoluteURL } });
    ...
    var Session = (function () {
        ...
        Session.prototype.notifyApplicationBeforeRender = function (newBody) {
            return dispatch("turbo:before-render", { detail: { newBody: newBody }, bubbles: true });
        };
        ...
        Session.prototype.notifyApplicationAfterPageLoad = function (timing) {
            ...
            return dispatch("turbo:load", { detail: { url: this.location.absoluteURL, timing: timing }, bubbles: true });
        };

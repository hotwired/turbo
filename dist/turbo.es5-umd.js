    ...
    var FrameController = (function () {
        function FrameController(element) {
            ...
            this.intersectionObserver = new IntersectionObserver(function (entries) {
                var src = _this.element.src;
                if (src) {
                    entries.forEach(function (_a) {
                        var isIntersecting = _a.isIntersecting;
                        if (isIntersecting) {
                            var value = _this.visit(src);
                            Object.defineProperty(_this.element, "loaded", { value: value, configurable: true });
                            _this.unobserveIntersections();
                        }
                    });
                }
            });

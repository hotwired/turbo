...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FetchResponse = (function () {
        ...
        Object.defineProperty(FetchResponse.prototype, "unprocessableEntity", {
            get: function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            responseHTML = _a.sent();
                            this.view.clearSnapshotCache();
                            this.proposeVisit(this.location, { response: { statusCode: fetchResponse.statusCode, responseHTML: responseHTML } });
                            return [2];
                    }
                });
            });

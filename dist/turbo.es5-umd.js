...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getLastPathComponent(location) {
    ...
    function appendToURLSearchParams(url, entries) {
        entries.reduce(function (params, _a) {
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.visit = function (url) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                var _this = this;
                return __generator(this, function (_a) {
                    location = expandPath(url.toString());
    ...
    var Visit = (function () {
        ...
        Visit.prototype.changeHistory = function () {
            if (!this.historyChanged) {
                var actionForHistory = this.location === this.referrer ? "replace" : this.action;
    ...
    var Navigator = (function () {
        ...
        Navigator.prototype.startVisit = function (location, restorationIdentifier, options) {
            if (options === void 0) { options = {}; }
            this.stop();
            this.currentVisit = new Visit(this, expandPath(location), restorationIdentifier, __assign({ referrer: this.location }, options));
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            location_1 = this.lastRenderedLocation || new URL(window.location.href);

...
class InternTestCase {
    ...
    static get tests() {
        return this.testNames.reduce((tests, testName) => {
            return Object.assign(Object.assign({}, tests), { [testName]: ({ remote }) => this.runTest(testName, remote) });
        }, {});
    }
    ...
    static runTest(testName, remote) {
...
class BrowserTestCase extends InternTestCase {
...
class TurboTestCase extends BrowserTestCase {
    constructor() {
        super(...arguments);
...
class AsyncScriptTests extends TurboTestCase {
    async setup() {
...
class NavigationTests extends TurboTestCase {
    async setup() {
...
class RenderingTests extends TurboTestCase {
    async setup() {
...
class VisitTests extends TurboTestCase {
    async setup() {

...
test("supports modifying a submission's Request's Headers in a turbo:submit-start listener", async ({ page }) => {
  await page.evaluate(() =>
...
test("supports modifying a Request's Headers in a turbo:before-fetch-request listener", async ({ page }) => {
  await page.evaluate(() =>
